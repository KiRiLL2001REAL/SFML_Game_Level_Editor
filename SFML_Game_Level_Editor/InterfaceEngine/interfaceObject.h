...
namespace edt {
	...
	public:
		static const struct sOptionMask {	// ћаски флагов
	...
	public:
		...
		virtual const sf::Vector2f getRelativeStartPosition() const;	// ¬озвращает начальную точку системы координат (ориентиру€сь на €корь)
